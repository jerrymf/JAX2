 ...
 * document.body.innerHTML = "<span>1</span><span>2</span><div id='cisla'></div>";
 * var all = JAX.all("*");
 * var elm = jaxElms.node(1); // vrati v poradi druhy prvek
 *
 * @param {Number} index pořadový index prvku
 * @returns {JAX.Node}
 */
JAX.NodeArray.prototype.node = function(index) {
 ...
 * var nodes = all.nodes(); // vrati pole prvku
 *
 * @returns {JAX.Node[]}
 */
JAX.NodeArray.prototype.nodes = function() {
